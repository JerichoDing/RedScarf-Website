...
(function() {
            ...
            var yuda1 = new Stack(document.getElementById('stack_yuda1'))
            var yuda2 = new Stack(document.getElementById('stack_yuda2'))
            var yuda3 = new Stack(document.getElementById('stack_yuda3'))
            ...
            document.querySelector('.button--accept[data-stack = stack_yuda1]').addEventListener(clickeventtype, function() { yuda1.accept(buttonClickCallback.bind(this)); });
            document.querySelector('.button--reject[data-stack = stack_yuda1]').addEventListener(clickeventtype, function() { yuda1.reject(buttonClickCallback.bind(this)); });

            document.querySelector('.button--accept[data-stack = stack_yuda2]').addEventListener(clickeventtype, function() { yuda2.accept(buttonClickCallback.bind(this)); });
            document.querySelector('.button--reject[data-stack = stack_yuda2]').addEventListener(clickeventtype, function() { yuda2.reject(buttonClickCallback.bind(this)); });

            document.querySelector('.button--accept[data-stack = stack_yuda3]').addEventListener(clickeventtype, function() { yuda3.accept(buttonClickCallback.bind(this)); });
            document.querySelector('.button--reject[data-stack = stack_yuda3]').addEventListener(clickeventtype, function() { yuda3.reject(buttonClickCallback.bind(this)); });
