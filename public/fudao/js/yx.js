    ...
    $(function() {
        ...
        Accordion.prototype.dropdown = function(e) {
            ...
            if (!e.data.multiple) {
                ...
                $el.find(".zk_img").html('<img src="https://www.highmarktutor.com/images/zk.png">展开');
            }
            if($this.parent().hasClass('open1')){
                $this.find(".zk_img").html('<img src="https://www.highmarktutor.com/images/zk1.png">收起');
            }else{
                $this.find(".zk_img").html('<img src="https://www.highmarktutor.com/images/zk.png">展开');
            }
